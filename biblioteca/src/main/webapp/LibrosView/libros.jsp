                            ...
                            <td>
                                        ...
                                        <c:choose>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <a href="LibroController?action=edit&id=${libro.id_libro}" class="btn btn-dark me-1">
                                        ...
                                        <c:otherwise>
                                            <div class="d-flex justify-content-center">
                                            <form id="activeForm" action="LibroController?action=active&id=${libro.id_libro}" method="post">    
                                                <button type="button" class="btn btn-warning" onclick="confirmActive();">
