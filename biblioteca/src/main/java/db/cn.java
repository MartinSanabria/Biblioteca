...
public class cn {
    ...
    private void createDatabase() {
        try {
            ...
            Path path1 = Paths.get("/Users/martinsanabria/Desktop/octavo ciclo/desarrollo multiplataforma/periodo 3/Parcial/Biblioteca/biblioteca/src/main/java/db/cn.java");
            Path path2 = Paths.get("/Users/martinsanabria/Desktop/octavo ciclo/desarrollo multiplataforma/periodo 3/Parcial/Biblioteca/biblioteca/src/main/webapp/Assets/database.sql");
             Path relativePath = path1.relativize(path2);
        
            // Imprime la ruta relativa entre ambos path
            System.out.println("Ruta relativa: " + relativePath);
            String archivoSQL = "/Users/martinsanabria/Desktop/octavo ciclo/desarrollo multiplataforma/periodo 3/Parcial/Biblioteca/biblioteca/src/main/webapp/Assets/database.sql";
